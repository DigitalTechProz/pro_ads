...
@section('title', 'Create New Ad Link Share')
            ...
            <div class="body">
                ...
                <div class="body">
                    <div class="row clearfix">
                        <form action="{{route('links.store')}}" method="post" class="card auth_form">
                             {{csrf_field()}}
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input id="ptc"  name="link" type="url"   class="form-control" placeholder="Enter Website Link">
                                </div>
                            </div>
                            <hr>
                            <div class="row clearfix">
                            ...
                            <button class="btn btn-info pull-right" type="submit">Create Link</button>
