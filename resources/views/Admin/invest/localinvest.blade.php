...
@section('title', 'View All User Investment Requests')
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($investment->status == 0)
                                                    <a href="{{route('admin.invest.update', $investment->id)}}" type="button" class="btn btn-success">
                                                        <i class="material-icons"></i> Aprove
                                                    </a>
                                                @endif
                                            </td>
