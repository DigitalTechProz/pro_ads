...
@section('title', 'View All User Deposit Requests')
    ...
    <div class="body_scroll">
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h2>All User Deposit Requests</h2>
                    <ul class="breadcrumb">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>All Deposit Requests </strong> Summary</h2>
                    ...
                    <div class="body">
                        @if (count($deposits) > 0)
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{config('app.currency_symbol')}} {{$deposit->charge}}</td>
                                            <td>{{config('app.currency_symbol')}} {{$deposit->net_amount}}</td>
                            ...
                            <h1 class="text-center">No  Deposit Requests Found</h1>
