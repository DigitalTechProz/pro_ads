...
<div class="navbar-right">
    <ul class="navbar-nav">
        ...
        @if (Auth::user()->usertype =='admin')
            <li class="dropdown">
                <a href="javascript:void(0);" class="dropdown-toggle" title="Withdrawals" data-toggle="dropdown" role="button"><i class="zmdi zmdi-apps"></i></a>
                <ul class="dropdown-menu slideUp2">
                    <li class="header">User Withdrawals</li>
                    <li class="body">
                        <ul class="menu app_sortcut list-unstyled">
                            <li>
                                <a href="{{route('admin.users.withdraws')}}">
                                    <div class="icon-circle mb-2 bg-blue"><i class="zmdi zmdi-money"></i></div>
                                    <p class="mb-0">All User Withdrawals</p>
                                </a>
                            </li>
                            <li>
                                <a href="{{route('admin.withdraw.requests')}}">
                                    <div class="icon-circle mb-2 bg-blue"><i class="zmdi zmdi-hourglass"></i></div>
                                    <p class="mb-0">Local Users Withdrawal Requests</p>
                                </a>
                            </li>
                        </ul>
                    </li>
        ...
        <li><a href="{{ route('logout') }}"  class="mega-menu" title="Sign Out" onclick="event.preventDefault();document.getElementById('logout-form').submit();"> <i class="zmdi zmdi-power"></i></a>
