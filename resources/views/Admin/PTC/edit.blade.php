            ...
            <div class="body">
                ...
                <div class="body">
                    <div class="row clearfix">
                        <form action="{{route('admin.ptc.update', ['id'=>$advertisement->id])}}" method="post" class="card auth_form">
                             {{csrf_field()}}
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input id="ptc"  name="ad_link" type="url" value="{{$advertisement->ad_link}}"  class="form-control" placeholder="Enter Website Link">
                                </div>
                            </div>
                            <hr>
                            <div class="row clearfix">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>Rewards</label>
                                        <input id="rewards"  name="rewards" type="text"  value="{{$advertisement->rewards}}" class="form-control" placeholder="Enter Rewards">
                                    </div>
                                </div>
                            </div>
                            <hr>
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input id="duration"  name="duration" type="number" value="{{$advertisement->duration}}"  class="form-control" placeholder="Enter Advert Duration">
                                    </div>
                                </div>
                            </div>
                            <hr>
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input id="hit"  name="hit" type="number"  value="{{$advertisement->hit}}" class="form-control" placeholder=" Enter Website Traffic Hit">
                                    </div>
                                </div>
                            </div>
                            <hr>
                            ...
                            <button class="btn btn-info pull-right" type="submit">Update PTC Ad</button>
